			...
			.click(
					function() {
						...
						$
								.ajax({
									type : 'POST',
									url : getRequestUrl('anonymous', 'reply',
											'create', null, null),
											...
											if ($("#replyer")
												...
												$(".content")
														.append(
																'<div class="discuss container border-box">'
																		...
																		+ '<a href="'
																		+ data.回复页面连接
																		+ '"><i class="icon-comment-alt"></i>回复</a>'
																		+ '<div class="clear">'
																		+ '</div>'
																		+ '</div>'
																		+ '<p class="time">第'
												...
												$(".content")
														.append(
																'<div class="discuss container border-box">'
																		+ '<div class="box">'
																		+ '<a href=../normal/othersProfile?submitFlag=query&othersId="'
																		+ data[i].person.personId
																		+ '"><img src=.."'
																		+ data.person.headUrl
																		+ '" class="border-box">'
																		+ '</a>'
...
function more(topicId) {
	...
	$
			.ajax({
				type : 'GET',
				url : '../anonymous/topic/' + topicId
						+ '/reply?submitFlag=query&offset=' + offset
						+ '&limit=' + limit,
				contentType : 'application/json',
				async : 'false',
				dataType : 'json',
...
$(document).delegate(
		...
		function() {
			...
			$(".comment-box .textarea").html(
					"<span class='delete'>回复<i>" + txt + '</i>：</span>');
